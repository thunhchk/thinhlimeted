	...
	toggleButton.Image = "rbxassetid://86749587185394"
	...
	if World3 then
		Tabs.Main:AddSection("thinh limeted mua nhé")
	...
	local TravelDress = Tabs.Main:AddToggle("TravelDress", {
		Title = "Tự động lên sea 2(yêu cầu level 700)",
		Description = "",
		Default = false
	})
	...
	local Zou = Tabs.Main:AddToggle("Zou", {
		Title = "Tự động lên sea 3 (yêu cầu level 1500)",
		Description = "",
		Default = false
	})
	...
	local FarmTyrant = Tabs.Main:AddToggle("FarmTyrant", {
		Title = "farm boss ở đảo tiki + đánh boss",
		Description = "",
		Default = false
	})
	...
	local FarmPhaBinh = Tabs.Main:AddToggle("FarmPhaBinh", {
		Title = "Phá Bình Triệu Hồi Boss tiki",
		Description = "",
		Default = false
	})
	...
	local FactoryRaids = Tabs.Main:AddToggle("FactoryRaids", {
		Title = "Đánh Nhà Máy",
		Description = "lưu ý phải ở sea 2 và đợi tầm (30p-1h)",
		Default = false
	})
	...
	local CastleRaids = Tabs.Main:AddToggle("CastleRaids", {
		Title = "Auto Đánh Hải Tặc,
		Description = "phải ở sea 3",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Farm Vật Chất Kì Dị",
		Description = "phải ở sea 2",
		Default = false
	})
	...
	local CheckCDK = Tabs.Quests:AddParagraph({
		Title = " Nhiệm vụ kiếm katana đôi bị nguyền rủa số ",
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "Tự động nhận CDK [ Nhiệm vụ cuối cùng ]",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Quests:AddButton({
		Title = "Buy Kiếm Katana ba chân chính",
		Description = "",
		Callback = function()
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "Từ người bán kiếm huyền thoại đến người bán kiếm huyền thoại",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Phụ kiện xe hơi Lei",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AutoKilo = Value
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Thành viên phi hành đoàn Auto Fish",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Thành viên phi hành đoàn Auto Haunted",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Cướp biển tự động tấn công GrandBrigade",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Thuyền cá tấn công tự động",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Quái thú biển tấn công tự động",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Leviathan tự động tấn công",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
...
spawn(function()
	...
	Tabs.Shop:AddButton({
		Title = "Buy võ karate người cá v2",
		Description = "",
		Callback = function()
			replicated.Remotes.CommF_:InvokeServer("BuySharkmanKarate")
		end
	...
	Tabs.Shop:AddButton({
		Title = "Buy Súng hỏa mai tinh luyện",
		Description = "",
		Callback = function()
	...
	Tabs.Server:AddButton({
		Title = "Nhảy đến máy chủ có Ping thấp nhất",
		Description = "",
		Callback = function()
	...
	Tabs.Server:AddButton({
		Title = "Dịch chuyển tức thời [Mã số công việc]",
		Description = "",
		Callback = function()
	...
	Tabs.Misc:AddButton({
		Title = "Chuyên gia Awakenings mở",
		Description = "",
		Callback = function()
	...
	HakiStat = Tabs.Misc:AddDropdown("HakiStat", {
		Title = "Chọn các trạng thái Haki",
		Values = HakiSt,
		Multi = false,
		Default = 1
	})
	...
	Tabs.Misc:AddButton({
		Title = "Loại bỏ sương mù trên bầu trời",
		Description = "",
		Callback = function()
	...
	Tabs.Misc:AddButton({
		Title = "Rain Fruits (Khách hàng)",
		Description = "",
		Callback = function()
			for i, v in pairs(game:GetObjects("rbxassetid://86749587185394")[1]:GetChildren()) do
	...
	walkWater = Tabs.Misc:AddToggle("walkWater", {
		Title = "Bật chế độ Đi trên mặt nước",
		Description = "",
		Default = true
	})
	...
	iceWalk = Tabs.Misc:AddToggle("iceWalk", {
		Title = "Bật Ice Walk",
		Description = "Đi bộ trên băng giống như đi bộ trên mặt nước nhưng có tác dụng đóng băng",
		Default = false
	})
